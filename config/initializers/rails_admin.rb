# RailsAdmin config file. Generated on April 05, 2012 23:03
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Cloned', 'Admin']
  ...
  # config.excluded_models = [StoryPage]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [StoryPage]
